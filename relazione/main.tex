...
La funzione di verosimiglianza è stata definita assumendo errori gaussiani indipendenti sui dati di $V_{rad}$ forniti da {\it Gaia}. La deviazione standard totale $\sigma_{tot}$ è stata calcolata combinando l'errore riportato dl dataset e l'incertezza derivante dalla misura della parallasse, attraverso la formula:
